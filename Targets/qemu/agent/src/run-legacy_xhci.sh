...
LD_PRELOAD=./hypertrash_crash_detector \
    /home/user/qemu-5.1.0/x86_64-softmmu/qemu-system-x86_64 -nographic -cdrom hypertrash.iso -m 100 -enable-kvm -device virtio-gpu-pci -device nec-usb-xhci -nographic 2> /tmp/data.log
